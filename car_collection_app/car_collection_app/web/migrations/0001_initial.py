    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model', models.CharField(max_length=20, validators=[car_collection_app.web.validators.min_two_char_len])),
                ('year', models.IntegerField(validators=[car_collection_app.web.validators.validate_year])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=10, validators=[car_collection_app.web.validators.min_two_char_len])),
